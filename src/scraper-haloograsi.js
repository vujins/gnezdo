...
// getLatest(houseSale, houseType, 0).then((rez) => console.log(rez));
getLatest(landSale, landType, 0).then((rez) => console.log(rez));
// getLatest(apartmentSale, apartmentType, 0).then((rez) => console.log(JSON.stringify(rez[0])));
